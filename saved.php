...
<section class="listings">
    <h1 class="heading">Imoveis salvados</h1>

    <div class="box-container">
      <?php

      $select_saved_property = $conn ->prepare("SELECT * FROM `saved` 
      WHERE user_id = ?");
      ...
      $select_listings = $conn -> prepare("SELECT * FROM `property` WHERE id = ?
       ORDER BY data DESC ");
      ...
      <?php 
       ...
       echo'<p class ="empty">Nenhum imovel publicado!</p>';
        ...
        echo'<p class ="empty">Nenhum imovel salvado!</p>';
      }
      ?>
